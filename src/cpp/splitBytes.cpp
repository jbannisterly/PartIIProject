...
std::vector<std::vector<uint8_t>> SplitBytes::Encode(std::vector<uint8_t> &data, std::vector<ErrorCorrectionVirtual*> &errorCorrectors) {
...
std::vector<uint8_t> SplitBytes::Decode(std::vector<std::vector<uint8_t>> &splitData, int dataLength) {
