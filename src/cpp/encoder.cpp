...
int main(int argc, char *argv[]){
    ...
    std::string outputPath = "output/img/output.png";
    ...
    if (compression) {
        compressedData = Compression::compress(byteData);
    } else {
        compressedData = byteData;
    }
    HeaderData::PrependLength(compressedData, compression);
