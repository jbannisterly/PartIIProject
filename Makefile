...
decoder:
	g++ -Wall -o output/Decoder src_cpp/decoder.cpp src_cpp/barcode_layout.cpp src_cpp/image_aux.cpp `pkg-config --cflags --libs opencv4`
	./output/Decoder

encoder:
	g++ -Wall -o output/Encoder src_cpp/encoder.cpp src_cpp/barcode_layout.cpp src_cpp/image_aux.cpp `pkg-config --cflags --libs opencv4`
	./output/Encoder
