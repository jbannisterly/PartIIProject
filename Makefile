...
decoder:
	g++ -Wall -Ilibs/ -o output/bin/Decoder src/cpp/decoder.cpp src/cpp/barcode_layout.cpp src/cpp/image_aux.cpp src/cpp/compressor.cpp `pkg-config --cflags --libs opencv4 zlib`
	./output/bin/Decoder

encoder:
	g++ -g -Ilibs/ -o output/bin/Encoder src/cpp/encoder.cpp src/cpp/barcode_layout.cpp src/cpp/image_aux.cpp src/cpp/compressor.cpp `pkg-config --cflags --libs opencv4 zlib`
	./output/bin/Encoder
